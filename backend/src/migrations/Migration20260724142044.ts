...
export class Migration20260724142044 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`create table "character" ("id" serial primary key, "first_name" varchar(255) not null, "last_name" varchar(255) not null, "dob" date not null, "gender" text not null, "phone_number" varchar(255) null, "address" varchar(255) null, "has_gun_permit" boolean not null default false, "flags" text[] not null default '{}', "user_id" uuid not null);`);
    ...
    this.addSql(`alter table "character" add constraint "character_user_id_foreign" foreign key ("user_id") references "user" ("id");`);
  }
